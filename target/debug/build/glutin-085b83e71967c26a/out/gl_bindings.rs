...
pub static mut FramebufferRenderbufferEXT: FnPtr = FnPtr {
            ...
            pub mod GetRenderbufferParameterivEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GetRenderbufferParameterivEXT = FnPtr::new(metaloadfn(loadfn, "glGetRenderbufferParameterivEXT", &[]))
                    }
                }
            }
            ...
            pub mod GenRenderbuffersEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GenRenderbuffersEXT = FnPtr::new(metaloadfn(loadfn, "glGenRenderbuffersEXT", &[]))
                    }
                }
            }
            ...
            pub mod RenderbufferStorageEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::RenderbufferStorageEXT = FnPtr::new(metaloadfn(loadfn, "glRenderbufferStorageEXT", &[]))
                    }
                }
            }
            ...
            pub mod IsFramebufferEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::IsFramebufferEXT = FnPtr::new(metaloadfn(loadfn, "glIsFramebufferEXT", &[]))
                    }
                }
            }
            ...
            pub mod IsRenderbufferEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::IsRenderbufferEXT = FnPtr::new(metaloadfn(loadfn, "glIsRenderbufferEXT", &[]))
                    }
                }
            }
            ...
            pub mod BindFramebufferEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::BindFramebufferEXT = FnPtr::new(metaloadfn(loadfn, "glBindFramebufferEXT", &[]))
                    }
                }
            }
            ...
            pub mod DeleteFramebuffersEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::DeleteFramebuffersEXT = FnPtr::new(metaloadfn(loadfn, "glDeleteFramebuffersEXT", &[]))
                    }
                }
            }
            ...
            pub mod FramebufferTexture2DEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::FramebufferTexture2DEXT = FnPtr::new(metaloadfn(loadfn, "glFramebufferTexture2DEXT", &[]))
                    }
                }
            }
            ...
            pub mod DeleteRenderbuffersEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::DeleteRenderbuffersEXT = FnPtr::new(metaloadfn(loadfn, "glDeleteRenderbuffersEXT", &[]))
                    }
                }
            }
            ...
            pub mod GetFramebufferAttachmentParameterivEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GetFramebufferAttachmentParameterivEXT = FnPtr::new(metaloadfn(loadfn, "glGetFramebufferAttachmentParameterivEXT", &[]))
                    }
                }
            }
            ...
            pub mod BindRenderbufferEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::BindRenderbufferEXT = FnPtr::new(metaloadfn(loadfn, "glBindRenderbufferEXT", &[]))
                    }
                }
            }
            ...
            pub mod FramebufferTexture1DEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::FramebufferTexture1DEXT = FnPtr::new(metaloadfn(loadfn, "glFramebufferTexture1DEXT", &[]))
                    }
                }
            }
            ...
            pub mod FramebufferTexture3DEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::FramebufferTexture3DEXT = FnPtr::new(metaloadfn(loadfn, "glFramebufferTexture3DEXT", &[]))
                    }
                }
            }
            ...
            pub mod GenFramebuffersEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GenFramebuffersEXT = FnPtr::new(metaloadfn(loadfn, "glGenFramebuffersEXT", &[]))
                    }
                }
            }
            ...
            pub mod GenerateMipmapEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GenerateMipmapEXT = FnPtr::new(metaloadfn(loadfn, "glGenerateMipmapEXT", &[]))
                    }
                }
            }
            ...
            pub mod CheckFramebufferStatusEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::CheckFramebufferStatusEXT = FnPtr::new(metaloadfn(loadfn, "glCheckFramebufferStatusEXT", &[]))
                    }
                }
            }
            ...
            pub mod FramebufferRenderbufferEXT {
                ...
                pub fn load_with<F>(loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::FramebufferRenderbufferEXT = FnPtr::new(metaloadfn(loadfn, "glFramebufferRenderbufferEXT", &[]))
                    }
                }
            }
